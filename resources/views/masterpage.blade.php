...
<head>
    <title>Don Puerto Portfolio</title>
    ...
    <link rel="stylesheet" href="{{ asset('css/css-global-compulsory.css') }}">
    ...
    <link rel="stylesheet" href="{{ asset('css/css-implements-plugins.css') }}">

    <!--[if lt IE 9]>
    <link rel="stylesheet" href="{{ asset('css/css-implements-plugins-ie8.css') }}" type="text/css" media="screen">
    <![endif]-->
    ...
    <!-- CSS Theme -->
    <link rel="stylesheet" href="{{ asset('css/css-theme-color.css') }}" id="style_color">

    <!-- CSS Customization -->
    <link rel="stylesheet" href="{{ asset('css/css-customization.css') }}">
</head>
...
<script src="{{ elixir('js/js-global-compulsory.js') }}"></script>


<!-- JS Implementing Plugins -->
<script src="{{ elixir('js/js-implementing-plugins.js') }}"></script>


<!-- JS Page Level-->
<script src="{{ elixir('js/js-page-level.js') }}"></script>
...
<!--[if lt IE 9]>
<script src="{{ elixir('js/js-IE9-support.js') }}"></script>
<![endif]-->

<!--[if lt IE 10]>
<script src="{{ elixir('js/js-IE10-support.js') }}"></script>
<![endif]-->
</body>
</html>